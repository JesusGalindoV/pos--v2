...
<div class="login-box">
  ...
  <div class="login-logo">
    ...
    <img src="vistas/img/plantilla/logo.farmacia.png" class="img-responsive" style="padding:30px 100px 0px 100px">
    ...
    <form method="post">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          ...
          <button type="submit" class="btn btn-primary btn-block btn-flat" data-toggle="modal" data-target="#modalAgregarUsuario">Registrarse</button>
